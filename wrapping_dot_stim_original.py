...
class wrappingDotStim(visual.DotStim):
    ...
    def _update_dotsXY(self):
        ...
        if self.fieldShape in  [None, 'square', 'sqr']:
            ...
            self._dotsXY[(self._dotsXY[:,1]>(self.fieldSize/2.0)),1] = numpy.subtract(numpy.mod((self._dotsXY[(self._dotsXY[:, 1]>(self.fieldSize/2.0)),1]), (self.fieldSize/2.0)),(self.fieldSize/ 2))
            self._dotsXY[(self._dotsXY[:,0]<-(self.fieldSize/2.0)),0] = numpy.mod(self._dotsXY[(self._dotsXY[:,0]<-(self.fieldSize/2.0)),0], (self.fieldSize/2.0))
            self._dotsXY[(self._dotsXY[:,1]<-(self.fieldSize/2.0)),1] = numpy.mod(self._dotsXY[(self._dotsXY[:,1]<-(self.fieldSize/2.0)),1], (self.fieldSize/2.0))
